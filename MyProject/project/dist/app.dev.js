...
var app = express(); //自定义路由模块

var commonRouters = require('./routers/commmonRouters.js');

var productRouters = require('./routers/productRouters.js');

var newsRouters = require('./routers/newsRouters.js'); //静态资源访问


app.use('/public/', express["static"]('public')); //注册模板引擎

app.engine('html', require('express-art-template'));
app.set("views", __dirname + "/views"); //post中间件
